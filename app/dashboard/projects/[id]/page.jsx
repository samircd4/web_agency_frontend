            ...
            <div className="flex-grow flex items-center justify-center px-3 lg:px-6 pb-3 lg:pb-6">
                <div className="flex flex-col items-center gap-3">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">
                        {loading || !currentUser ? 'Decrypting Command Space...' : 'Loading Project...'}
                    </span>
                </div>
            </div>
        );
                    ...
                    >
                        ...
                        <div className="p-4 lg:p-6 space-y-6">
                            ...
                            <section>
                                ...
                                <div className="custom-markdown text-slate-400">
                                    {project.description ? (
                                        <ReactMarkdown
                                            components={{
                                                ...
                                                blockquote: ({ ...props }) => <blockquote className="border-l-4 border-brand-teal pl-4 italic text-slate-400 my-4" {...props} />,
                                        ...
                                        <p className="text-slate-500">No detailed brief provided.</p>
                                    )}
                                </div>
                            </section>
                                    ...
                                    <div className="space-y-2">
                                        {milestones.map((m, mi) => (
                                            ...
                                            >
                                                ...
                                                <span className={`text-xs font-bold flex-grow leading-normal ${m.done ? 'text-slate-500 line-through' : 'text-white'}`}>
                                                    {m.label}
                                                </span>
                                            </div>
                                        ))}
                                    ...
                                    <div className="max-h-[450px] overflow-y-auto space-y-4 border-l border-white/5 ml-1.5 pl-4 pr-2">
                                        {activities.map((log) => (
                                            <div key={log.id} className="relative">
                                                ...
                                                <div className="text-xs text-slate-400 leading-normal">{log.action_text}</div>
                                            </div>
                                        ))}
                                    </div>
                                </section>
