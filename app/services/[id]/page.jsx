      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="flex-grow lg:max-w-4xl">
            ...
            {/* Image Gallery */}
            <div className="relative aspect-video rounded-[3.5rem] overflow-hidden border border-white/10 mb-12 shadow-2xl group">
              <Image 
                src={service.image} 
                alt={service.title} 
                fill 
            ...
            <div className="mb-16">
              <h2 className="text-2xl font-black text-white mb-8 uppercase tracking-tight">Mission Briefing</h2>
            ...
            {/* Features Grid */}
            <div className="mb-16">
              <h2 className="text-2xl font-black text-white mb-6 uppercase tracking-tight">Technical Highlights</h2>
            ...
            {service.roadmap && (
              <div className="mb-16">
                <h2 className="text-2xl font-black text-white mb-8 uppercase tracking-tight">Delivery Roadmap</h2>
            ...
            {service.clientReviews && (
              <div className="mb-16">
                <h2 className="text-2xl font-black text-white mb-8 uppercase tracking-tight">Client Reviews</h2>
            ...
            {service.faqs && (
              <div className="mb-16">
                <h2 className="text-2xl font-black text-white mb-8 uppercase tracking-tight">Common Questions</h2>
