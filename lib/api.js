...
export const api = {
    ...
    // ─── Client Seller Communications ───────────────────────────────────────

    async startSellerChat(data = {}) {
        return request("/client/communications/start_seller_chat/", {
            method: "POST",
            body: JSON.stringify(data),
        });
    },
    ...
    async getClientChatThreads() {
        return request("/client/communications/threads/");
    },

    async getClientThreadMessages(threadId) {
        const url = threadId ? `/client/communications/messages/?thread_id=${threadId}` : "/client/communications/messages/";
        return request(url);
    },

    async sendClientThreadMessage(data = {}) {
        let body;
