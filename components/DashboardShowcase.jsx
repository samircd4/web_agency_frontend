...
export default function DashboardShowcase() {
    return (
        <section
            className="py-12 md:py-16 relative bg-[#0f172a] overflow-hidden"
            id="dashboard"
        >
            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="w-full lg:w-[65%] xl:w-[70%] relative group"
                    >
                        ...
                        <div className="relative bg-[#1e293b] rounded-[32px] border border-white/10 p-2 md:p-3 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.8)]">
                            <div className="bg-[#0f172a] rounded-[22px] overflow-hidden border border-white/5 aspect-video flex items-center justify-center relative">
                                ...
                                <Image
                                    ...
                                    className="object-fill group-hover:scale-[1.02] transition-transform duration-700 block"
                                    priority
                                />
                        ...
                        <motion.div
                            ...
                            className="absolute -top-12 -right-12 hidden lg:block z-20 cursor-grab active:cursor-grabbing"
                        >
                            <motion.div
                                animate={{ y: [0, 10, 0] }}
                                transition={{ duration: 5, repeat: Infinity, ease: 'easeInOut' }}
                                className="w-48 h-[380px] bg-[#1e293b] rounded-[36px] border-[5px] border-[#334155] shadow-2xl p-2 overflow-hidden"
                            >
                                <div className="bg-[#0f172a] h-full w-full rounded-[28px] overflow-hidden relative pointer-events-none">
                    ...
                    <div className="w-full lg:w-[35%] xl:w-[30%]">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                        >
                            <span className="text-[10px] font-black uppercase tracking-[0.4em] text-brand-blue mb-6 block">
                                Unified Interface
                            </span>
                            ...
                            <div className="space-y-6 mb-12">
                                {[
                                    {
                                        text: 'Live Data Synchronization',
                                        color: 'text-brand-blue'
                                    },
                                    {
                                        text: 'Automated Multi-Channel Sync',
