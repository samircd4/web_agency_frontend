...
export default function Navbar() {
    ...
    if (!mounted) return (
        <nav className="fixed top-0 left-0 w-full z-[100] py-0 lg:py-2">
            <div className="w-full lg:container mx-auto px-0 lg:px-4">
                <div className="glass border-white/10 rounded-none lg:rounded-2xl px-4 py-3 flex items-center justify-between bg-white/5 h-14" />
            </div>
        </nav>
    );
